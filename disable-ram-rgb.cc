...
// Original: https://gist.githubusercontent.com/aditya-r-m/dc006a278274a9615a05587ab965e0df/raw/6746f42a54448122a60a49b07618f82b07e555a8/crgb.cc
// Basic usage: g++ disable-ram-rgb.cc -o build/disable-ram-rgb && sudo ./build/disable-ram-rgb
// Prerequisites: sudo apt install id2-tools g++
// For turning off RAM LEDs at startup: copy to the root home directory & add "@reboot /root/disable-ram-rgb" to "sudo crontab -e"
